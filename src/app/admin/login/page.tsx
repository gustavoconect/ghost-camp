                    ...
                    <form className="space-y-6" onSubmit={handleLogin}>
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-slate-900 border border-slate-700 text-white rounded-xl px-4 py-3.5 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors text-base"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="magnetic-btn w-full flex justify-center items-center gap-2 py-4 px-4 rounded-xl text-base font-bold text-white bg-orange-600 hover:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 disabled:opacity-50 transition-all shadow-[0_0_20px_rgba(234,88,12,0.2)] min-h-[52px] cursor-pointer"
                        >
                            {loading ? (
                                <>
