...
export function EquipmentCard({ equipment }: { equipment: Equipment }) {
    ...
    const [imgSrc, setImgSrc] = useState(
        equipment.image_urls?.[0] || 'https://images.unsplash.com/photo-1504280390224-ddee6b219569?q=80&w=2000&auto=format&fit=crop'
    );
    ...
    return (
        <div className="group flex flex-col h-full bg-slate-900/60 border border-slate-700/50 overflow-hidden hover:border-blue-500/40 transition-all duration-300 rounded-2xl">
            ...
            <Link href={`/catalogo/${equipment.id}`} className="block">
                <div className="relative aspect-square overflow-hidden bg-slate-900">
                    <Image
                        ...
                        onError={() => {
                            setImgSrc('https://images.unsplash.com/photo-1504280390224-ddee6b219569?q=80&w=800&auto=format&fit=crop');
                        }}
            ...
            <div className="p-3 sm:p-4 flex-1 flex flex-col">
                ...
                <button
                    ...
                    className={`w-full mt-auto font-bold text-xs transition-all duration-200 flex items-center justify-center gap-1.5 cursor-pointer min-h-[44px] h-11 rounded-xl outline-none active:scale-[0.97] ${added
